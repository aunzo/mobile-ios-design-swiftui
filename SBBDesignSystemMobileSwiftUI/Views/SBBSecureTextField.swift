 ...
 */
public struct SBBSecureTextField: View {
...
struct SBBSecureTextField_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            Group {
                SBBSecureTextField(text: .constant("Text"))
                    .previewDisplayName("Light without placeholder")
                SBBSecureTextField(text: .constant(""), label: "Placeholder")
                    .previewDisplayName("Light empty")
                SBBSecureTextField(text: .constant("Text"), label: "Placeholder")
                    .previewDisplayName("Light with text")
                SBBSecureTextField(text: .constant("Text"), label: "Placeholder", icon: Image(sbbIcon: .route_circle_start_small))
            ...
            Group {
                SBBSecureTextField(text: .constant("Text"), error: "Error")
                    .previewDisplayName("Light without placeholder, error")
                SBBSecureTextField(text: .constant(""), label: "Placeholder", error: "Error")
                    .previewDisplayName("Light empty, error")
                SBBSecureTextField(text: .constant("Text"), label: "Placeholder", error: "Error")
                    .previewDisplayName("Light with text, error")
                SBBSecureTextField(text: .constant("Text"), label: "Placeholder", error: "Error", icon: Image(sbbIcon: .route_circle_start_small))
